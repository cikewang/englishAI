...
const (
	Chat_GetChat_FullMethodName = "/gpt.api.chat.Chat/GetChat"
)
...
func (c *chatClient) GetChat(ctx context.Context, in *GetChatRequest, opts ...grpc.CallOption) (*GetChatReply, error) {
	out := new(GetChatReply)
	err := c.cc.Invoke(ctx, Chat_GetChat_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedChatServer) GetChat(context.Context, *GetChatRequest) (*GetChatReply, error) {
